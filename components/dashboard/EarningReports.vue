  ...
  <v-card elevation="10">
    <v-card-item>
      ...
      <v-row class="mt-4">
        <v-col
          cols="12"
          class="d-flex flex-column py-4 border-b"
          v-for="item in EarningReportsData"
          :key="item.title"
        >
          <div class="d-flex justify-space-between ga-3 align-center">
            <div class="d-flex ga-3 align-center">
              <div
                :class="
                  'rounded-pill d-flex justify-center align-center py-2 px-4 bg-light' + item.color
                "
              >
                <Icon
            ...
            <v-chip :color="item.statuscolor" size="small">
              <icon icon="solar:alt-arrow-up-bold" height="12" class="me-1"></icon>
              {{ item.statustext }}
            </v-chip>
          </div>
        </v-col>
      ...
      <div class="pt-10 pb-2 text-center custom-text-primary">
        <RouterLink
          to=""
          class="text-decoration-none text-h6 textPrimary font-weight-medium custom-title"
          >View more markets
        </RouterLink>
      </div>
    </v-card-item>
