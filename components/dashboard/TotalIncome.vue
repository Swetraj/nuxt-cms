    ...
    <v-card-item>
      <div class="d-flex justify-space-between align-center mb-mb-0 mb-3">
        <div class="d-flex ga-3 align-center">
          ...
          <v-card-title class="text-h6 textSecondary font-weight-medium mb-0"
            >Total Income
          </v-card-title>
        </div>
      ...
      <v-row class="d-flex justify-space-between align-end mt-5">
        <v-col cols="7" xl="5" class="mb-1">
          ...
          <span
            class="text-12 rounded-pill px-2 py-1 lh-normal text-muted border border-muted font-weight-medium"
            >+18% last month</span
          >
        </v-col>
        <v-col cols="5" xl="5">
